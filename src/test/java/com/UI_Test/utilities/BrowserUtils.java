...
///converting numbers to letters
    ...
    public static String convert(final int n){
        ...
        if (n<100000){
            return convert(n/1000)+" Thousand"+((n%100!=0)? " ":"")+convert(n%1000);
        }
        if (n<10000000){
...
///////////////////////////////////////////////////////////////////////
    ...
    public static int monthInLetter(String monthinLetter){
        int month=0;
     String[] months={"January","February","March","April","May","June","July","August","September","October","November","December"};
     String[] monthsNumber={"01","02","03","04","05","06","07","08","09","10","11","12"};
        for (int i = 0; i <12 ; i++) {
        if (monthinLetter.equals(months[i])){
            month=Integer.parseInt(monthsNumber[i]);
        }
    ...
    public static void dropDown(WebElement element, String [] texts){
       waitForVisibility(element,5);
        ...
        String visibleText=texts[index];
